...
type ActiveMQArtemisFSM struct {
	...
	customResource *ctyapi.ActiveMQArtemisContinuity
	r              *ReconcileActiveMQArtemis
}

// Need to deep-copy the instance?
func MakeActiveMQArtemisFSM(instance *ctyapi.ActiveMQArtemisContinuity, _namespacedName types.NamespacedName, r *ReconcileActiveMQArtemisContinuity) ActiveMQArtemisFSM {
