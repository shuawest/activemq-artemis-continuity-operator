...
func TestActiveMQArtemisContinuityController_Reconcile(t *testing.T) {
	...
	t.Run("ActiveMQArtemisContinuity", func(t *testing.T) {
		t.Run("cluster", func(t *testing.T) {
			amq := ctyv2alpha1.ActiveMQArtemisContinuity{}
